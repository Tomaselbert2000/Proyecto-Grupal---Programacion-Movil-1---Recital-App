    ...
    class Account : AppCompatActivity() {
        ...
        lateinit var goBackToSettingsButton: MaterialButton
        lateinit var goToEditUserButton: MaterialButton
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            goBackToSettingsButton = findViewById(R.id.Account_BackwardsButton)
            goToEditUserButton = findViewById(R.id.Account_EditAttributesButton)
            ...
            goBackToSettingsButton.setOnClickListener {
                finish()
            }

            goToEditUserButton.setOnClickListener {
